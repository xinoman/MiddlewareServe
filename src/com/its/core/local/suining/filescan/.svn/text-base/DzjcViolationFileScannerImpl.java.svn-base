...
/**
 * 创建日期 2015年4月23日 下午6:19:01
 * @author GuoPing.Wu
 * Copyright: Xinoman Technologies CO.,LTD.
 */
public class DzjcViolationFileScannerImpl extends AViolationFileScanner1 {
	private static final Log log = LogFactory.getLog(DzjcViolationFileScannerImpl.class);
	...
	protected ViolationInfoBean parseViolationInfo(String scanDir, File imageFile) throws Exception {
		...
		if (StringHelper.isNotEmpty(fileNameSplit2[2]) && !fileNameSplit2[2].equals(".JPG")) {
			String plate = StringHelper.replace(fileNameSplit2[2], ".JPG", "");
			bean.setPlateNo(plate);
		}
