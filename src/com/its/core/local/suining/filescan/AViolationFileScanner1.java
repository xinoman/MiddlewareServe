...
/**
 * 创建日期 2015年4月23日 下午5:28:32
 * @author GuoPing.Wu
 * Copyright: Xinoman Technologies CO.,LTD.
 */
public abstract class AViolationFileScanner1 extends AFileScanner {
	private static final Log log = LogFactory.getLog(AViolationFileScanner1.class);
		...
		for (int j = 0; j < len; j++) {
			if (files[j].isDirectory()){
				...
				*/
				...
				Date date = null;
				try {
					timeStr = fileName.substring(fileName.indexOf("#")-10,fileName.indexOf("#")+7);
