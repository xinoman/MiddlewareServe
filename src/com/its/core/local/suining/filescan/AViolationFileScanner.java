...
//							byte[] md5 = CryptoHelper.getUniHzImageEncryptString(resultFileByte).getBytes();
							String md5String = CryptoHelper.getUniHzImageEncryptString(resultFileByte);
							if(StringHelper.isNotEmpty(violationInfoBean.getMd5())){
								md5String = violationInfoBean.getMd5();
							}
							byte[] md5 = md5String.getBytes();
