...
public class HttpRequester {
	...
	public static void main(String[] args) {
		try {
			...
			propertys.put("accept", "application/xml");
			HttpRequester request = new HttpRequester();
			//http://hkuatwf03.wisers.com:8080/api/information/login/RNDTEST/api/sdmhEj9q
			HttpRespons hr = request.sendGet("http://dev-api.wisers.com/api/information/getCategory?token=20E3ADF189D52CADD95FF504D9B052D9",null,propertys);
