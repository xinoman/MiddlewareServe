...
/**
 * 创建日期 2012-12-13 下午05:20:23
 * @author GuoPing.Wu QQ:365175040
 * Copyright: ITS Technologies CO.,LTD.
 */
public abstract class AViolationFile1FileScanner extends AFileScanner {
	private static final Log log = LogFactory.getLog(AViolationFile1FileScanner.class);
