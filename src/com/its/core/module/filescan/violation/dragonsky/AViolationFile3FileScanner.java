...
/**
 * 创建日期 2012-12-14 下午06:05:17
 * @author GuoPing.Wu QQ:365175040
 * Copyright: ITS Technologies CO.,LTD.
 */
public abstract class AViolationFile3FileScanner extends AFileScanner {
	private static final Log log = LogFactory.getLog(AViolationFile3FileScanner.class);
		...
		for (int j = 0; j < len; j++) {
			if (files[j].isDirectory()){
				...
				*/
				...
				Date date = null;
				try {
					timeStr = fileName.substring(0, 14);
