...
/**
 * 创建日期 2013-4-22 下午08:51:55
 * @author GuoPing.Wu
 * Copyright: Xinoman Technologies CO.,LTD.
 */
public class ViolationFileScannerTestImpl extends AViolationFileScanner {
	...
	protected ViolationInfoBean parseViolationInfo(String scanDir, File imageFile) throws Exception {
		...
		String deviceId = fileName.substring(0, 5);
		...
		String timeStr = fileName.substring(6, 20);
